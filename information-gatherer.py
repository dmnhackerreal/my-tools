...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        print(f"{Fore.RED}Usage: python info_gatherer.py <Target_URL_or_Domain>{Style.RESET_ALL}")
        print(f"{Fore.YELLOW}Example (URL): python info_gatherer.py http://example.com{Style.RESET_ALL}")
        print(f"{Fore.YELLOW}Example (Domain): python info_gatherer.py example.com{Style.RESET_ALL}")
        sys.exit(1)
